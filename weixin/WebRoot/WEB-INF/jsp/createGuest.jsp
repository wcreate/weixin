			...
			<form action="#" method="post">
				...
				<div class="form-group">
					<div class="col-xs-12  ">
						<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
							<input type="text" id="mainBusiness" name="mainBusiness" class="form-control" placeholder="成立时间">
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-xs-12  ">
						<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
							<input type="text" id="consultProblem" name="consultProblem" class="form-control" placeholder="项目估值">
						</div>
					</div>
				</div>
				<div class="form-group">
